<template>
    <div class="cont">
        ...
        <div class="popup" ref="popup" id="noblur">
                ...
                <router-link class="rout" :to="{name: 'admin', params:{id: this.info}}">Ok</router-link>
        </div>
        ...
        <div class="login">
            <div class="input-icons">
                ...
                <div class="chechD">
                <input id="showPassword" class="checkbox" type="checkbox" @click="showPassword()"> 
                        ...
                        password: this.user.password
                            ...
                            .then(response => {
                                if (response.data.success) {
                                    ...
                                    this.state = true;
                                    this.loginF = 'login';
                                    window.sessionStorage.setItem("admin-token",this.info);
                                }
                            })
                            .catch(function (e) {
                                console.log(e);
